...
class PdfInvoice {
    createInvoice (letter: Letter, callback) {
        ...
        // Draw Images
        doc.image(Config.getBasePath() + '/util/invoice/pdf/assets/logo.png', 234, 21, { width: 125.88})
            .image(Config.getBasePath() + '/util/invoice/assets/box.png', 48, 446, {width: 497.765});
        //.fontSize(25)
