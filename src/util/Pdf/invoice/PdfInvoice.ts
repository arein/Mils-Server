...
class PdfInvoice {
    public static createInvoice (letter: Letter, callback: (error: Error, data?: string) => void) {
        ...
        try {
            ...
            // Draw Images
            doc.image(Config.getBasePath() + '/util/pdf/invoice/assets/logo.png', 234, 21, { width: 125.88})
                .image(Config.getBasePath() + '/util/pdf/invoice/assets/box.png', 48, 446, {width: 497.765});
            //.fontSize(25)
            ...
            doc.font('OpenSans-Regular')
                ...
                .text(letter.financialInformation.net + '€', 479, 511)
                .text("VAT (" + letter.financialInformation.vatRate.toString().replace("0.", "") + "%)", 71, 530)
                .text(letter.financialInformation.vat + '€', 479, 530);

            if (letter.financialInformation.settlementCurrency === Currency.EUR) {
                // Final Amount
                doc.fontSize(18)
                    .fillColor("#3470B8")
                    .text('Final Amount', 49.235, 626.458)
                    .text(letter.financialInformation.price + '€', 432.095, 626.458, {width: 100, align: 'right'})
                    .fillColor("#000000")
                    .fontSize(14)
                ...
                doc.fontSize(18)
                    ...
                    .text('Final Amount', 49.235, 626.458)
                    .text(letter.financialInformation.price + '€', 432.095, 626.458, {width: 100, align: 'right'})
                    .text('Final Amount in ' + CurrencyConverter.convertCurrencyTypeToString(letter.financialInformation.settlementCurrency), 49.235, 656.458)
                    .text(letter.financialInformation.priceInSettlementCurrency, 432.095, 656.458, {width: 100, align: 'right'})
                    .fillColor("#000000")
                    .fontSize(14)
                    .text("Your credit card was charged with the amount due.", 49.235, 680.464);
            }
            ...
            doc.font('OpenSans-Bold')
                .fontSize(18)
                .fillColor("#3470B8")
                .text('Thank you for using Mils!', 49.235, 704.458);

            doc.font('OpenSans-Regular')
                .fontSize(14)
                .fillColor("#000000")
                .text('Inquiries? Errors? Problems? Please get in touch via ', 49.235, 731.458)
                .fillColor("#3470B8")
                .text("billing@milsapp.com", 385.235, 731.458)
                .link(385.235, 731.458, 85, 20, "mailto:billing@milsapp.com");

            doc.output(function (data: string) {
