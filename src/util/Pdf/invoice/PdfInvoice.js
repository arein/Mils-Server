...
var PdfInvoice = (function () {
    ...
    PdfInvoice.prototype.createInvoice = function (letter, callback) {
        ...
        // Bill Content
        doc.font('OpenSans-Regular').fontSize(12).fillColor("#000000").text(description, 71, 511).text(letter.financialInformation.net + '€', 479, 511).text("VAT", 71, 530).text(letter.financialInformation.vat + '€', 479, 530);
        ...
        // Footer
        doc.font('OpenSans-Bold').fontSize(18).fillColor("#3470B8").text('Thank you for using Mils!', 49.235, 694.458);

        doc.font('OpenSans-Regular').fontSize(14).fillColor("#000000").text('Inquiries? Errors? Problems? Please get in touch via ', 49.235, 721.458).fillColor("#3470B8").text("billing@milsapp.com", 385.235, 721.458).link(385.235, 721.458, 85, 20, "mailto:billing@milsapp.com");
