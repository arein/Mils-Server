...
var Postful = (function () {
    function Postful() {
    }
    Postful.prototype.sendMail = function (filepath, recipient, callback) {
    ...
    Postful.prototype.calculatePrice = function (pages, destinationCountryIso, callback) {
        var price = 0.28;
...
module.exports = Postful;
//# sourceMappingURL=postful.js.map
